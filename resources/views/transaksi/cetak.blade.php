...
<body onload="javascript:window.print()">
    <div class="invoice">
        ...
        <p>
            ...
            Tanggal : {{ $penjualan->tanggal ? date('d/m/Y H:i:s', strtotime($penjualan->tanggal)) : 'Tanggal Tidak Tersedia' }} <br>
            Pelanggan : {{ $pelanggan ? $pelanggan->nama : 'Pelanggan Tidak Tersedia' }} <br>
            Kasir : {{ $user->nama }}
        </p>
        <hr>
